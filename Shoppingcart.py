...
if __name__ == "__main__":
    ...
    obj_cart.add_item("Mango", 76, 6.20)
    obj_cart.add_item("Banana", 96, 11.50)
    obj_cart.add_item("Passion", 85, 9.60)
    ...
    disc_cart.add_item("Banana", 96, 11.50)
    disc_cart.add_item("Passion", 85, 9.60)
    print(">>> Applying a 15% Discount <<<")


    # 3) Applying Tax
    taxed_cart = TaxedCart(tax_rate=0.07)
    taxed_cart.add_item("Mango", 7, 4.00)
    taxed_cart.add_item("Banana", 9, 15.00)
    taxed_cart.add_item("Passion", 32, 5.20)
